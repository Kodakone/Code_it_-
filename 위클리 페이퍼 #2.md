...
<img width="1042" height="677" alt="image" src="https://github.com/user-attachments/assets/23dccd52-0eeb-40f5-b8f9-b9bf4f10a34e" />
...
## 편향: 모델이 예측값을 충분히 학습하지 못했을때 나타나는 현상
예측값들과 실제값들이 대체로 멀리 떨어져 있는가?
## 분산: 모델이 예측값을 과도하게 학습할 때 나타나는 현상
예측값들이 본인들 끼리 멀리 흩어져 있는가?
...
따라서, 편향과 분산이 한쪽이 과하지 않고 적절한 차원이나 값이 되어야 Fitting이 잘 되었다고 볼 수 있암.
